...
export const SpotlightIcon: React.FC<{ className?: string }> = ({
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 15a5 5 0 100-10 5 5 0 000 10z"
    />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={2}
      d="M12 2v4m0 12v4m-9-9h4m12 0h4m-2.93-7.07l2.83-2.83m-12.73 0l2.83 2.83m12.73 12.73l-2.83-2.83m-12.73 0l-2.83 2.83"
    />
  </svg>
);

export const CaptureIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
